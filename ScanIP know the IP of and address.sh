...
## Software name, what is this, version, informations.
	echo "Software name: IP know address"
	echo
...
address=$(zenity --entry --title="DNS Lookup" --text="Enter the website address:" --entry-text="www.hotmail.com" --width=400)

if [ -z "$address" ]; then
	zenity --error --text="No address entered. Defaut www.hotmail.com will be used." --width=300
	adrress=www.hotmail.com
	fi

echo "The IP for the name address $address is :"


nslookup "$address" | awk '/^Address: / {print $2}' | head -n1
...
## Exit, wait or auto-quit.
	...
	echo
	echo "${green}	███████████████ Finish, quit in 1 seconds █████████████████${reset}"
	echo
	sleep 1
	exit
